...
const ResultsScreen = ({ frequency, onReset }) => {
  ...
  const handleCompleteSession = () => {
    ...
    alert('Session completed! Therapist notes and signature saved.');
    onReset();
  };
  ...
  return (
    <div className="results-screen">
      ...
      <div className="results-navigation">
        <button className="btn" onClick={handleCompleteSession} style={{ width: '100%', fontSize: '18px', padding: '16px' }}>
          Complete Session →
        </button>
      </div>
    </div>
